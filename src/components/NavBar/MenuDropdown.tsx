          ...
          <NavDropdown top={{ sm: 'unset', lg: '56' }} bottom={{ sm: '56', lg: 'unset' }} right="0">
            <Column gap="16">
              ...
              >
                ...
                <SecondaryLinkedText href="https://docs.kroma.network">
              ...
              <IconRow>
                <Icon href="https://discord.com/invite/kroma">
                  <DiscordIconMenu
                ...
                <Icon href="https://twitter.com/kroma_network">
                  <TwitterIconMenu
                    className={styles.hover}
                    width={24}
                    height={24}
                ...
                <Icon href="https://github.com/kroma-network">
                  <GithubIconMenu
                    className={styles.hover}
                    width={24}
                    height={24}
