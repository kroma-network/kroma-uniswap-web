...
export const V2_FACTORY_ADDRESSES: AddressMap = constructSameAddressMap('0x71578C96Db4eD52a06d98acc90BFd0E0317d1Fe0')
export const V2_ROUTER_ADDRESS: AddressMap = constructSameAddressMap('0x3962aE58CE9B7f9485923C121d2A31C5B6b24a0a')
